...
G = nx.MultiDiGraph()
G.add_weighted_edges_from([('amarshalkin', 'infom', 200, {'color':'blue'}),('amarshalkin', 'infom', 100, {'color':'red'}), ('klimov', 'amarshalkin', 300), ('amarshalkin', 'fedorov', 150), ('fedorov', 'klimov', 50)])
ax1 = plt.subplot(212)
